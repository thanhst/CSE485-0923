...
<body>
    ...
    <div class="mb-5 mt-5 d-flex justify-content-center align-items-center">
        <form action="../progress/login/progressLogin.php" method="post" class="form-group p-3 bg-gray rounded-3 d-flex flex-column gap-3 pb-5">
            ...
            <div class="input-group"><i class="bi bi-person-fill input-group-text"></i><input type="text" placeholder="Username" name="Username" class="form-control"></div>
            <div class="input-group"><i class="bi bi-key-fill input-group-text"></i><input type="text" placeholder="Password" name="Password" class="form-control"></div>
