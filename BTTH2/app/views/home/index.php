        ...
        <div id="carourelButton" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="<?=DOMAIN.'/public/img/musiclife1.png'?>" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="<?=DOMAIN.'/public/img/music2.jpg'?>" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="<?=DOMAIN.'/public/img/music3.jpg'?>" class="d-block w-100" alt="...">
                </div>
            </div>
